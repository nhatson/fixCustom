...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($this->dataHelper->isEnabled()) {
            ...
            if ($success) {
                $this->messageManager->addSuccessMessage(__("Orders were successfully cancelled!"));
            } else {
                $this->messageManager->addWarningMessage(__("Some orders was not successfully cancelled. Please check log file for more information!"));
            }
        } else {
